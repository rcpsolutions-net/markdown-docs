...
graph TD
    ...
    classDef highlight fill:#fef9ff,stroke:#fe8a04
    B -- Method 3: Back Office Manual Entry --> I[Restrictive UI Form]:::highlight
    H --> J[Federal Reserve Routing Check & Bank-Length Validation]:::highlight
    I --> J
